...
namespace ScheduleWidget.ScheduledEvents
{
    ...
    public class Schedule : ISchedule
    {
        ...
        public Schedule(RecurringEvent aEvent)
        {
            _event = aEvent;
            TemporalExpression = Create();
        }

        public Schedule(RecurringEvent aEvent, IEnumerable<DateTime> excludedDates)
        {
            _event = aEvent;
            TemporalExpression = Create(excludedDates);
        }

        public Schedule(RecurringEvent aEvent, UnionTE excludedDates)
        {
            _event = aEvent;
            TemporalExpression = Create(excludedDates);
        }
        ...
        private static RangeEachYearTE GetRangeForYear(RecurringEvent aEvent)
        {
