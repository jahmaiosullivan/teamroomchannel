...
namespace ScheduleWidget.ScheduledEvents
{
    ...
    public class RecurringEvent
    {
        ...
        /// </summary>
        static public int RoughlyEstimateMinimumEventOccurrences(RecurringEvent eventInstance)
        {
        ...
        /// </summary>
        static public bool AreEventSchedulesEqual(RecurringEvent first, RecurringEvent second)
        {
